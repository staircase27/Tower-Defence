 ...
 */
public final class TowerDefenceOld {
    ...
    public TowerDefenceOld(Grid grid,HashMap<Point,Areas> areas) {
        this.grid = grid;
        this.areas = areas;
        initialise();
        generateRoutes();
    }
    TowerDefenceOld(Grid grid,HashMap<Point,Areas> areas,boolean hehe) {
        this.grid = grid;
        this.areas = areas;
        //initialise();
        //generateRoutes();
