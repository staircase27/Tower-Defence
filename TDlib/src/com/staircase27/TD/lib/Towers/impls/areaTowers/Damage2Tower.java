 ...
 */
public class Damage2Tower extends DamagingTower implements AreaTowerInterface{
    public Damage2Tower(){
    ...
    public Pair<Class<? extends BaseTower>> getUpgrades() {
        return new Pair<Class<? extends BaseTower>>(Damage3Tower.class, WeakenTower.class);
    }
