 ...
 */
public class BoostTower extends BaseTower implements AreaTowerInterface{
    
    public static final double BOOST=0.1;
    
    @Override
    public Pair<Class<? extends BaseTower>> getUpgrades() {
        return new Pair<Class<? extends BaseTower>>(StrengthenTower.class, RateTower.class);
    }
