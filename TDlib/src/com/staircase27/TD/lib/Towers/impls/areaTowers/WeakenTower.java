 ...
 */
public class WeakenTower extends BaseTower implements AreaTowerInterface{
    
    public static final double weaken=0.2;
    ...
    public void enterArea(BaseEnemy enemy) {
        enemy.setVunerability(enemy.getVunerability()*(1+weaken));
    }
